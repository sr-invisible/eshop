...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="{{URL::asset('backend/vendor/morrisjs/morris.css')}}" rel="stylesheet">
...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Category manage<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Product manage<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
    ...
    <script src="{{URL::asset('backend/vendor/morrisjs/morris.min.js')}}"></script>
    <script src="{{URL::asset('backend/data/morris-data.js')}}"></script>
